...
const ContactPage: React.FC = () => {
    ...
    //         icon: Mail,
    //         title: 'Email Us',
    //         details: ['support@bongoquiz.co.ke', 'info@bongoquiz.co.ke'],
    //         description: 'Get support or general inquiries',
    //         color: '#3B82F6',
    //         gradient: 'linear-gradient(135deg, #3B82F6 0%, #2563EB 100%)',
    //         action: 'mailto:support@bongoquiz.co.ke'
    //     },
    //     {
    //         icon: Phone,
    //         title: 'Call Us',
    //         details: ['+254 700 123 456', '+254 711 789 012'],
    ...
    //     //     icon: MapPin,
    //     //     title: 'Visit Us',
    //     //     details: ['Nairobi, Kenya', 'Westlands Business Park'],
    ...
    //         icon: Clock,
    //         title: 'Response Time',
    //         details: ['Within 24 hours', 'Weekends: 48 hours'],
    ...
    //     { icon: MessageCircle, value: '10K+', label: 'Queries Solved' },
    //     { icon: Headphones, value: '24/7', label: 'Support Available' },
    //     { icon: Award, value: '98%', label: 'Satisfaction Rate' }
    // ];
    //
    // const socialLinks = [
    //     { icon: Facebook, href: '#', label: 'Facebook', color: '#1877F2', followers: '15K' },
    //     { icon: Twitter, href: '#', label: 'Twitter', color: '#1DA1F2', followers: '10K' },
    //     { icon: Instagram, href: '#', label: 'Instagram', color: '#E4405F', followers: '25K' },
    //     { icon: Youtube, href: '#', label: 'YouTube', color: '#FF0000', followers: '5K' }
    // ];

    // const faqs = [
    //     {
    //         question: "How quickly can I expect a response?",
    //         answer: "We typically respond within 24 hours on weekdays and 48 hours on weekends."
    //     },
    //     {
    //         question: "Do you offer phone support?",
    //         answer: "Yes! You can reach us at +254 700 123 456 during business hours."
    //     },
    //     {
    //         question: "Can I visit your office?",
    //         answer: "Absolutely! Schedule a meeting with us via email and we'd be happy to meet."
    //     }
    // ];
